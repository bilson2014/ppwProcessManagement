...
//双击事件和失去焦点事件文本框的显示
function dbmatter(){
//	$('#calendar .city-select .city-cont dd a').click(function(){
//		var magic=$('.matter').val();
//		magic.each(function(){
//    		var magics=$(this).val();
//    		console.log(magics);
//    		
...
//		
////		shdfjashfkajshfkja
////		$('.matter').attr('style', 'border: none; resize: none;background: transparent;box-shadow: none;');
//	});
...
//            	添加当前的内容到当前时间下面            	
//            	console.log($(".fc-week td[data-date="+time+"]").find(".matter").val());
