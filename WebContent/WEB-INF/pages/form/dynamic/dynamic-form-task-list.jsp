...
<head>
    ...
    <script src="${ctx }/resources/js/common/plugins/jui/extends/timepicker/jquery-ui-timepicker-addon.js" type="text/javascript"></script>
	<script src="${ctx }/resources/js/common/plugins/jui/extends/i18n/jquery-ui-date_time-picker-zh-CN.js" type="text/javascript"></script>
	<script src="${ctx }/resources/js/common/plugins/validate/jquery.validate.pack.js" type="text/javascript"></script>
	<script src="${ctx }/resources/js/common/plugins/validate/messages_cn.js" type="text/javascript"></script>
	...
	<script src="${ctx }/resources/js/common/plugins/blockui/jquery.blockUI.js" type="text/javascript"></script>
	...
	<script src="${ctx }/resources/js/module/form/dynamic/dynamic-form-handler.js" type="text/javascript"></script>
</head>
